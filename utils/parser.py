...
def get_args():
    ...
    parser.add_argument(
        '--config', 
        type = str,
        default="cfgs/Plant/Plant_pretrain.yaml",
        # default="cfgs/pre-training/point-m2ae.yaml",
        # default="cfgs/pre-training/point_ma3e.yaml",
        # default="cfgs/fine-tuning/modelnet40.yaml",
        # default="cfgs/linear-svm/modelnet40.yaml",
    ...
    # some args
    parser.add_argument('--exp_name', type = str, default='plant_mae_GELU', help = 'experiment name')
