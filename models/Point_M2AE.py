...
class H_Encoder(nn.Module):
    ...
    def forward(self, neighborhoods, centers, idxs, eval=False):
        ...
        for i in range(len(centers)):
            ...
            # x_vis = self.encoder_blocks[i](x_vis,pos,mask_vis_att,masked_center)
...
class Point_M2AE(nn.Module):
    def __init__(self, config):
        ...
        for i in range(len(self.group_sizes)):
            ...
            #self.group_dividers.append(Group_v4(num_group=self.num_groups[i], group_size=self.group_sizes[i]))
